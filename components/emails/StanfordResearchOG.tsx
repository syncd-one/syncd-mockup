    ...
    <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
      ...
      <div className="p-4">
        ...
        <p className="mb-4">
          ...
          early detection of neurodegenerative diseases, and we've made some
          exciting progress. However, we believe that combining our expertise
          with your groundbreaking work in AI ethics and bias mitigation could
          lead to a more robust and ethically sound system.
        </p>

        <p className="mb-4">
          Here's a brief overview of what we envision for this collaboration:
        </p>
        ...
        <p className="mb-4">
          We're particularly interested in your recent work on ensuring fairness
          in medical AI systems across diverse populations. We believe this
          could be crucial in developing a system that's not only accurate but
          also equitable.
        </p>

        <p className="mb-4">
          If you're interested, I'd love to set up a video call to discuss this
          further. We're also planning a workshop next month where we'll be
          presenting our current findings. It would be wonderful if you could
          attend and perhaps give a talk on ethical considerations in medical
          AI.
        </p>

        <p className="mb-4">
          Please let me know your thoughts on this potential collaboration and
          if you'd be available for a call next week. I'm excited about the
          possibilities this partnership could bring to both our institutions
          and, more importantly, to the field of medical AI.
        </p>
